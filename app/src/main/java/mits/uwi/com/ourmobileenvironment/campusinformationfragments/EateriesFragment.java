...
public class EateriesFragment extends Fragment {
    ...
    public class EateriesAdapter extends RecyclerView.Adapter<EateriesAdapter.EateriesViewHolder> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView =(LayoutInflater)getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE).inflate(R.layout.cardview_eateries,null);
            Restaurant restaurant=eateries.get(position);
            ...
            NetworkImageView mNetworkImageView=(NetworkImageView)convertView.findViewById(R.id.eateries_photo);
