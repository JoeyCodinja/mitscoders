...
public class GlobalRequestHandler {
    ...
    public void getRestaurantList(ArrayList<Restaurant> RList, EateriesActivity eateriesActivity){
        ...
        RestaurantListener restaurantListener=new RestaurantListener("RestaurantList",RList,eateriesActivity,mCtx,Restaurant.class);
        RestaurantErrorListener restaurantErrorListener=new RestaurantErrorListener(Restaurant.class,mCtx,eateriesActivity,RList);
